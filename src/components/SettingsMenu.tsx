...
/**
 * In-session sheet: only what's relevant mid-receival (operator name, end
 * session). App-level settings (passcode, test tools, diagnostics, updates)
 * live on the top-level Settings screen reached from Home.
 */
